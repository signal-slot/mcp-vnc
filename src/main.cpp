...
int main(int argc, char *argv[])
{
    ...
    server.registerToolSet(tools, {
        ...
        { "checkPixelColor", "Check whether the pixel color at a specific coordinate matches the expected color. Returns \"true\" if the color matches, or \"false (actual: #RRGGBB)\" showing the actual color if it does not match. Useful for verifying UI state before proceeding with actions." },
        ...
        { "checkPixelColor/color", "Expected color in hex format (e.g., \"#FF0000\" for red, \"#FFFFFF\" for white). Compared using RGB values, alpha is ignored." },
